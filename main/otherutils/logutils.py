...
timeFile = time.strftime("%Y-%m-%d-%H-%M", time.localtime())
# os.path.dirname() 获取指定文件路径的上一级   os.getcwd()获取当前路径
filepath = os.path.dirname(os.getcwd()) + '/log/'
filename = filepath + timeFile + '.log'
